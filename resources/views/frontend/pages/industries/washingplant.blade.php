                ...
                <div class="col-lg-12">
                    <div class="ttm-page-title-row-inner">
                        <div class="page-title-heading">
                            <h2 class="title">Washing Plant</h2>
                        </div>
                        <div class="breadcrumb-wrapper">
                            <span>
                                <a title="Homepage" href="{{ route('home') }}">Home</a>
                            </span>
                            <span>Washing Plant</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title title-style-center_text">
                            <div class="title-header">
                                <h3>GALLERY</h3>
                                <h2 class="title">Explore Our <b>Washing Plant</b></h2>
                            </div>
                            <div class="title-desc">
                                <p>Snapshots from washing processes, equipment, and quality validation.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row slick_slider mb_15 mt_15"
                            ...
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid"
                                        ...
                                        alt="Washing plant image 1" />
                                </div>
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Equipment" data-rel="prettyPhoto"
                            ...
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid"
                                        ...
                                        alt="Washing plant image 2" />
                                </div>
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Process Flow" data-rel="prettyPhoto"
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid"
                                        ...
                                        alt="Washing plant image 3" />
                                </div>
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Quality Validation"
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="#">Quality Validation</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
