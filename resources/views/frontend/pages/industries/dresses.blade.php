                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title title-style-center_text">
                            <div class="title-header">
                                <h3>GALLERY</h3>
                                <h2 class="title">Explore Our <b>Dresses</b></h2>
                            </div>
                            <div class="title-desc">
                                <p>Highlights from dress production: styles, textures, and quality checks.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                ...
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Dress Tailoring" data-rel="prettyPhoto"
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="#">Dress Tailoring</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                ...
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Fabric Drape" data-rel="prettyPhoto"
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                ...
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Quality Check" data-rel="prettyPhoto"
