                ...
                <div class="col-lg-12">
                    <div class="ttm-page-title-row-inner">
                        <div class="page-title-heading">
                            <h2 class="title">Togs (E-Commerce)</h2>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title title-style-center_text">
                            <div class="title-header">
                                <h3>GALLERY</h3>
                                <h2 class="title">Explore Our <b>E‑Commerce</b></h2>
                            </div>
                            <div class="title-desc">
                                <p>Visuals from product listings, imagery styling, and digital presentation.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid"
                                        src="{{ asset('frontend/assets/images/portfolio/portfolio-04-768x512.jpg') }}"
                                        alt="E-commerce image 1" />
                                </div>
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Product Styling" data-rel="prettyPhoto"
                                        href="{{ asset('frontend/assets/images/portfolio/portfolio-04-1200x800.jpg') }}">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="#">Product Styling</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid"
                                        src="{{ asset('frontend/assets/images/portfolio/portfolio-05-768x512.jpg') }}"
                                        alt="E-commerce image 2" />
                                </div>
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Catalog Imagery" data-rel="prettyPhoto"
                                        href="{{ asset('frontend/assets/images/portfolio/portfolio-05-1200x800.jpg') }}">
                                        <i class="flaticon flaticon-measuring-tape"></i>
                                    </a>
                                    <a href="#" class="ttm_link"><i class="flaticon flaticon-returning"></i></a>
                                </div>
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="#">Catalog Imagery</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                <div class="featured-thumbnail">
                                    <img class="img-fluid"
                                        src="{{ asset('frontend/assets/images/portfolio/portfolio-06-768x512.jpg') }}"
                                        alt="E-commerce image 3" />
                                </div>
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Digital Presentation"
                                        data-rel="prettyPhoto"
                                        href="{{ asset('frontend/assets/images/portfolio/portfolio-06-1200x800.jpg') }}">
                                        <i class="flaticon flaticon-measuring-tape"></i>
                                    </a>
                                    <a href="#" class="ttm_link"><i class="flaticon flaticon-returning"></i></a>
                                </div>
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="#">Digital Presentation</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
