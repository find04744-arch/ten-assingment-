                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title title-style-center_text">
                            <div class="title-header">
                                <h3>GALLERY</h3>
                                <h2 class="title">Explore Our <b>Design</b></h2>
                            </div>
                            <div class="title-desc">
                                <p>Concept sketches, material boards, and sample executions from our design teams.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                ...
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Design Concept" data-rel="prettyPhoto"
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                ...
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Material Board" data-rel="prettyPhoto"
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="featured-imagebox featured-imagebox-portfolio style2">
                            <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                ...
                                <div class="ttm-media-link">
                                    <a class="ttm_prettyphoto ttm_image" title="Sample Execution" data-rel="prettyPhoto"
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3><a href="#">Sample Execution</a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
