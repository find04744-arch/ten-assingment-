...
@section('content')
    ...
    <div class="ttm-page-title-row ttm-bg ttm-bgimage-yes ttm-bgcolor-darkgrey clearfix"
        style="background-image: url('{{ asset('frontend/assets/images/services/services-02-1200x800.jpg') }}');">
                ...
                <div class="col-lg-12">
                    <div class="ttm-page-title-row-inner" style="padding: 100px 0;">
                        <div class="page-title-heading">
                            <h2 class="title" style="font-size: 60px;">Men's Products</h2>
                            <p style="color: #fff; font-size: 18px; margin-top: 10px; font-weight: 500;">Sophistication &
                                Comfort</p>
                        </div>
                            ...
                            <div class="ttm-service-description mb-50 text-center">
                                <div class="section-title">
                                    <div class="title-header">
                                        <h2 class="title" style="font-size: 50px;">About Men's Products</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p class="lead text-muted">Discover our premium collection of men's apparel,
                                            designed for style, comfort, and durability. From casual wear to formal attire,
                                            our range embodies modern fashion trends while maintaining timeless elegance.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="pr-lg-4">
                                                <div class="ttm_single_image-wrapper ttm_single_image_hover">
                                                    ...
                                                    @else
                                                        <img class="img-fluid border-radius-5"
                                                            src="{{ asset('frontend/assets/images/services/services-01-768x512.jpg') }}"
                                                            alt="placeholder">
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 order-1 order-md-2">
                                            <div class="pl-lg-4">
                                                <div class="ttm_single_image-wrapper ttm_single_image_hover">
                                                    ...
                                                    @else
                                                        <img class="img-fluid border-radius-5"
                                                            src="{{ asset('frontend/assets/images/services/services-02-768x512.jpg') }}"
                                                            alt="placeholder">
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="col-12">
                                <div class="section-title text-center mb-50 gallery-section-title">
                                    <div class="title-header">
                                        ...
                                        <p class="gallery-subtitle">Discover our sophisticated and comfortable men's
                                            collection.</p>
                                ...
                                <div class="row gallery-grid">
                                    @forelse($gallery as $item)
                                        <div class="col-md-4 col-sm-6 mb-4 gallery-grid-item"
                                            ...
                                            <div class="ttm_single_image-wrapper ttm_single_image_hover">
                                                <a href="{{ $item->image_path ? asset('storage/' . $item->image_path) : asset('frontend/assets/images/portfolio/portfolio-01-600x700.jpg') }}"
                                                    ...
                                                    @else
                                                        <img class="img-fluid border-radius-5"
                                                            src="{{ asset('frontend/assets/images/portfolio/portfolio-01-600x700.jpg') }}"
                                                            alt="placeholder">
                                                    @endif
                                                    <div
                                                        class="ttm-icon ttm-icon_element-border ttm-icon_element-color-white ttm-icon_element-size-xs">
                                    ...
                                    @empty
                                        <div class="col-12">
                                            <div class="alert alert-info text-center">No gallery images available.</div>
                                        </div>
                                    @endforelse
                                </div>
                            </div>
