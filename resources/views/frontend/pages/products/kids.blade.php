...
@section('content')
    ...
    <div class="ttm-page-title-row ttm-bg ttm-bgimage-yes ttm-bgcolor-darkgrey clearfix"
        style="background-image: url('{{ asset('frontend/assets/images/single-img-09.png') }}');">
                ...
                <div class="col-lg-12">
                    <div class="ttm-page-title-row-inner" style="padding: 100px 0;">
                        <div class="page-title-heading">
                            <h2 class="title" style="font-size: 60px;">Kids' Products</h2>
                            <p style="color: #fff; font-size: 18px; margin-top: 10px; font-weight: 500;">Comfort & Fun for
                                Little Ones</p>
                        </div>
                            ...
                            <div class="ttm-service-description mb-50 text-center">
                                <div class="section-title">
                                    <div class="title-header">
                                        <h2 class="title" style="font-size: 50px;">About Kids' Products</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p class="lead text-muted">Our kids' collection is designed with fun, comfort,
                                            and durability in mind. We understand that children need clothes that allow them
                                            to play freely while looking their best. From vibrant colors to soft,
                                            skin-friendly fabrics, every piece is crafted to handle the energy of childhood.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="section-title text-center mb-50 gallery-section-title">
                                        <div class="title-header">
                                            ...
                                            <p class="gallery-subtitle">Vibrant and playful designs for your little ones.
                                            </p>
