...
<div class="auth-card">
    ...
    <p class="auth-card-sub">Sign in to your PromptHub account</p>

    @if(session('status'))
        <div class="f-alert f-alert-success">
            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" style="flex-shrink:0;margin-top:1px"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"/></svg>
            {{ session('status') }}
        </div>
    @endif
    ...
    <form action="{{ route('login') }}" method="POST" novalidate>
        ...
        <div class="f-group">
            ...
            <div class="f-input-wrap" style="margin-top:8px">
                <span class="f-icon">
                ...
                <button type="button" class="f-toggle" onclick="togglePw('pwField',this)" title="Show/hide">
                    <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8" id="pwEye"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </button>
            </div>
        ...
        <div class="f-group" style="margin-bottom:22px">
            <label class="f-check">
                ...
                <span class="f-check-label">Keep me signed in</span>
            </label>
        </div>

        <button type="submit" class="f-btn">
            <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2" style="display:inline;margin-right:6px;vertical-align:middle"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75"/></svg>
            Sign In
        </button>
    </form>

    <p class="f-footer">Don't have an account? <a href="{{ route('register') }}">Create one free</a></p>
</div>
